...
public class AccountManager implements IAccountManager {
    ...
    public AccountManager(JSONObject userData) {
        accountMap = new HashMap<>();
        for (Object username : userData.keySet()) {
            IJsonToObject jsonToObject = new JsonToObject();
            String jsonString = userData.get(username).toString();
            Account account = jsonToObject.fromJson(jsonString, Account.class);
            accountMap.put((String) username, account);
        }
    }
    ...
    public JSONObject toJson() {
        IObjectToJson objectToJson = new ObjectToJson();
        String jsonString = objectToJson.toJson(accountMap);
